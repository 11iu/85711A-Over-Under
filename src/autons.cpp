...
Autons::Autons(lemlib::Chassis &chassis, pros::ADIDigitalOut &wings, pros::ADIDigitalOut &vertWings, pros::Motor &intake, pros::Motor &cata, pros::ADIUltrasonic &rightSonic, pros::Distance &distanceBack, pros::ADIUltrasonic &intakeSonic) : 
        chassis(chassis), wings(wings), vertWings(vertWings), intake(intake), cata(cata), rightSonic(rightSonic), distanceBack(distanceBack), intakeSonic(intakeSonic) {}
...
void Autons::autoSkills()
{
    ...
    chassis.moveToPose(fieldX - tile / 2.0, fieldY - tile * 1.5, 0, 4000,
                    {.minSpeed = 80}, false);
    chassis.moveToPose(fieldX - tile / 2.0, fieldY - tile * 1.5, -60, 4000,
                    {.minSpeed = 80}, false);
