...
void curvature_drive()
{
    ...
    int leftY = lemlib::defaultDriveCurve(controller.get_analog(pros::E_CONTROLLER_ANALOG_LEFT_Y), 10);
    int rightX = lemlib::defaultDriveCurve(controller.get_analog(pros::E_CONTROLLER_ANALOG_RIGHT_X), 10);
